 ...
 */ (function(factory) {
    ...
    var GridStack = function(el, opts) {
        ...
        if (!self.opts.staticGrid && typeof self.opts.removable === 'string') {
            ...
            trashZone.on('dropover', function(event, ui) {
                var el = $(ui.draggable);
        ...
        if (!self.opts.staticGrid && self.opts.acceptWidgets) {
            ...
            var onDrag = function(event, ui) {
                ...
                if (!node._added) {
                    ...
                    self.placeholder.attr('data-gs-x', node.x)
    ...
    GridStack.prototype._updateStyles = function(maxHeight) {
        ...
        if (maxHeight > this._styles._max) {
            for (var i = this._styles._max; i < maxHeight; ++i) {
                ...
                prefix + '[data-gs-height="' + (i + 1) + '"]', 'height: ' + getHeight(i + 1, i) + ';',
                i);
                Utils.insertCSSRule(this._styles,
                prefix + '[data-gs-min-height="' + (i + 1) + '"]', 'min-height: ' + getHeight(i + 1, i) + ';',
                i);
                Utils.insertCSSRule(this._styles,
                prefix + '[data-gs-max-height="' + (i + 1) + '"]', 'max-height: ' + getHeight(i + 1, i) + ';',
                i);
                Utils.insertCSSRule(this._styles,
                prefix + '[data-gs-y="' + i + '"]', 'top: ' + getHeight(i, i) + ';',
                i);
            }
    ...
    GridStack.prototype._prepareElementsByNode = function(el, node) {
            ...
            if (event.type == 'drag') {
                if (x < 0 || x >= self.grid.width || y < 0) {
                    ...
                    if (node._temporaryRemoved) {
                        self.grid.addNode(node);
                        self.placeholder.attr('data-gs-x', x)
                            .attr('data-gs-y', y)
        ...
        var onStartMoving = function(event, ui) {
            ...
            self.placeholder.attr('data-gs-x', o.attr('data-gs-x'))
