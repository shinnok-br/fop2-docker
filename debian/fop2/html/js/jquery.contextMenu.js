        ...
        defaults = {
            ...
            positionSubmenu: function($menu) {
                if ($.ui && $.ui.position) {
                    // .position() is provided as a jQuery UI utility
                    // (...and it won't work on hidden elements)
                    $menu.css('display', 'block').css('max-height','400px').position({
                        my: "left top",
                        at: "right top",
                        of: this,
                        collision: "flipfit fit"
                    }).css('display', '').css('overflowY','scroll');
                } else {
                    // determine contextMenu position
                    var offset = {
                        top: 0,
                ...
                $.each(opt.items, function(key, item) {
                    ...
                    if (typeof item == "string") {
                        ...
                        if (item.type && item.type != 'sub' && item.type != 'html') {
                            $input.on('focus', handle.focusInput)
    ...
    $.contextMenu = function(operation, options) {
        ...
        switch (operation) {
            case 'create':
                ...
                switch (o.trigger) {
                    case 'hover':
                        $context.on('mouseenter' + o.ns, o.selector, o, handle.mouseenter)
